...
public class ReportesItems extends javax.swing.JInternalFrame {
    ...
    void listar(){
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            ob[3]=lista.get(i).getValor_unitario();
            ob[4]=lista.get(i).getRepresentante();
            modelo.addRow(ob);
        }
    ...
    void agregar(){
        ...
        ob[2]=Double.parseDouble(valor_uni);
        ob[3]=representante;
        dao.add(ob);
    }
    ...
    void actualizar(){
        ...
        if(fila==-1){
            ...
            obJ[2]=Double.parseDouble(valor_uni);
            obJ[3]=representante;
            obJ[4]=id;
            dao.actualizar(obJ);
        }
    ...
    private void initComponents() {
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txtValorunitario, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        tabla1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "NOMBRE", "CANTIDAD", "VALOR UNITARIO", "REPRESENTANTE"
            }
        ));
    ...
    private void tabla1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla1MouseClicked
        ...
        if(fila==-1){
            ...
            String valor_uni=tabla1.getValueAt(fila, 3).toString();
            String representante=tabla1.getValueAt(fila, 4).toString();
